...
cd $program_dir
make CXX=$CPR_CXX CC=$CPR_CC  LDFLAGS="-lcpr_runtime -L/CPR/lib -L/klee/build/lib  -lkleeRuntest -I/klee/source/include" -j32 data_structures_set_multi_proc_ground-1
