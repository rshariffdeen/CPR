...
cp eureka_01-1.c $program_dir
cd $program_dir
make CXX=$TRIDENT_CXX CC=$TRIDENT_CC  LDFLAGS="-ltrident_runtime -L/CPR/lib -L/klee/build/lib  -lkleeRuntest -I/klee/source/include" -j32 eureka_01-1
