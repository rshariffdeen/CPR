...
PROJECT_CFALGS="-g -std=c++11 ${LIB_FUZZING_ENGINE} -Llibavcodec -Llibavdevice -Llibavfilter -Llibavformat -Llibavresample -Llibavutil -Llibpostproc -Llibswscale -Llibswresample -L${FFMPEG_DEPS_PATH}  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments   libavdevice/libavdevice.a libavfilter/libavfilter.a libavformat/libavformat.a libavcodec/libavcodec.a libpostproc/libpostproc.a libswresample/libswresample.a libswscale/libswscale.a libavutil/libavutil.a -lavdevice -lavfilter -lavformat -lavcodec -lpostproc -lswresample -lswscale -lavutil -lass -lm -lharfbuzz -lfontconfig -lexpat -lfreetype -lexpat -lfribidi -lfreetype -lz -lpng12 -lz -lm -lva -lva-drm -lva-x11 -lxcb -lXau -lXdmcp -lxcb -lXau -lXdmcp -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lXau -lXdmcp -lxcb-shape -lxcb -lXau -lXdmcp -L /data/ffmpeglibs/lib -lstdc++ -lm -lrt -ldl -lnuma -L${FFMPEG_DEPS_PATH} -lvpx -lm -lpthread -L${FFMPEG_DEPS_PATH} -lvpx -lm -lpthread -L${FFMPEG_DEPS_PATH} -lvpx -lm -lpthread -L${FFMPEG_DEPS_PATH} -lvpx -lm -lpthread -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -L${FFMPEG_DEPS_PATH} -lopus -lm -L${FFMPEG_DEPS_PATH} -lopus -lm -lmp3lame -lfreetype -lz -lpng12 -lz -lm -L${FFMPEG_DEPS_PATH} -lfdk-aac -lm -lass -lm -lharfbuzz -lfontconfig -lexpat -lfreetype -lexpat -lfribidi -lfreetype -lz -lpng12 -lz -lm -lm -llzma -lz"
make ${subject}
