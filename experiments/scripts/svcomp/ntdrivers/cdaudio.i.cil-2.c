...
BOOLEAN CdAudioIsPlayActive(PDEVICE_OBJECT DeviceObject )
{ PCD_DEVICE_EXTENSION deviceExtension ;
  PIRP irp_CdAudioIsPlayActive = (PIRP)__VERIFIER_nondet_ulong() ;
  IO_STATUS_BLOCK ioStatus ;
  KEVENT event ;
  NTSTATUS status = __VERIFIER_nondet_long() ;
...
{ DRIVER_OBJECT d ;
  ...
  status = 256;
  IRP irp ;
  int we_should_unload = 2;
  klee_make_symbolic(&we_should_unload, sizeof(int), "unload");
  int __BLAST_NONDET___0 = 0 ;
  klee_make_symbolic();
